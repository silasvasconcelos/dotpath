import pytest
from dotpath import __version__, getpath
...
def test_default_value_dic():
    ...
    assert default_dog_name_dic == 'Jorge', f'Value was {default_dog_name_dic}, should be Jorge.'
    assert default_cat_name_dic == 'Felix', f'Value was {default_cat_name_dic}, should be Felix.'
...
def test_default_value_obj():
    ...
    assert default_dog_name_obj == 'Jorge', f'Value was {default_dog_name_obj}, should be Jorge.'
    assert default_cat_name_obj == 'Felix', f'Value was {default_cat_name_obj}, should be Felix.'
